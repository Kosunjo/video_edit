...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://13.125.181.147:5005/api/v1/signup', {
        method: 'POST',
        headers: {
  ...
  const handleSendVerification = async () => {
    ...
    try {
      const response = await fetch('http://13.125.181.147:5005/api/v1/send-verification', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleVerifyEmail = async () => {
    ...
    try {
      const response = await fetch('http://13.125.181.147:5005/api/v1/verify-email', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
